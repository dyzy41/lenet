...
class MSCANet(nn.Module):
    ...
    def __init__(self,  backbone='resnet18', output_stride=16, img_size = 256, img_chan=3, chan_num = 32, n_class =2):
        ...
        self.re_weights1 = CDWeights(32, norm_cfg=norm_cfg)
        self.re_weights2 = CDWeights(32, norm_cfg=norm_cfg)
        self.re_weights3 = CDWeights(32, norm_cfg=norm_cfg)
    ...
    def forward(self, img1, img2):
        ...
        x1_s16, x2_s16 = self.re_weights1(x1_s16, x2_s16)
        ...
        x1_s8, x2_s8 = self.re_weights2(x1_s8, x2_s8)
