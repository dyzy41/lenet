...
from .C2FNet import SemiModel
from .FTANet.model import BaseNet as FTANet



@MODELS.register_module()
class MM_FTANet(EncoderDecoder):
    def __init__(
        self,
...
@MODELS.register_module()
class MM_C2FNet(EncoderDecoder):
    def __init__(
        self,
        backbone: ConfigType = None,
        decode_head: ConfigType = None,
