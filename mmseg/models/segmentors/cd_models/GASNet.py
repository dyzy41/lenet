...
import torch.nn as nn
import torch.nn.functional as F
# https://github.com/xiaoxiangAQ/GAS-Net
...
class GASNet(nn.Module):
    def __init__(self, backbone='resnet34', output_stride=16, f_c=64, freeze_bn=False, in_c=3):
    ...
    def forward(self, hr_img1, hr_img2):
        ...
        output = self.conv_final(torch.cat([x1, x2], dim=1))
